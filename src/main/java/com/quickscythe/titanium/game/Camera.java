...
import com.quickscythe.titanium.game.board.Scene;
import com.quickscythe.titanium.game.board.MenuScene;
...
public class Camera {
    ...
    private double rwidth = 1600;
//    private double rwidth = 1280;
    private double rheight = 900;
...
//        ge.getScreenDevices()
    ...
    public void update() {
        if (current_board == null) current_board = new MenuScene();
